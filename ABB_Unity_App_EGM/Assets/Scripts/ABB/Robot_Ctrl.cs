...
public class Robot_Ctrl : MonoBehaviour
{
    ...
    public static class ABB_EGM_Control
    {
        ...
        public static readonly int port_number = 58691;//6511;//
        // Joint Space:
        //  Orientation {J1 .. J6} (°)
    ...
    {
        // IP Port Number and IP Address
        public static string ip_address = "127.0.0.1"; //"192.168.125.81";
        public static readonly int port_number = 6061;//58692;
        // End-effector:
    ...
    void Start()
    {
        ...
        GlobalVariables_Main_Control.C_Position_Limit[2, 0] = 0.0f; GlobalVariables_Main_Control.C_Position_Limit[2, 1] = 1100.0f;
        //  Set Min/Max limits: Orientation in degrees
        GlobalVariables_Main_Control.C_Orientation_Limit[0, 0] = -200.0f; GlobalVariables_Main_Control.C_Orientation_Limit[0, 1] = 200.0f;
        GlobalVariables_Main_Control.C_Orientation_Limit[1, 0] = -200.0f; GlobalVariables_Main_Control.C_Orientation_Limit[1, 1] = 200.0f;
        GlobalVariables_Main_Control.C_Orientation_Limit[2, 0] = -200.0f; GlobalVariables_Main_Control.C_Orientation_Limit[2, 1] = 200.0f;

        //ABB_EGM_Control.C_Position[0] = 550.0f;
        //ABB_EGM_Control.C_Position[1] = 0.0f;
        //ABB_EGM_Control.C_Position[2] = 950.0f;
        //ABB_EGM_Control.C_Orientation[0] = -180.0f;
        //ABB_EGM_Control.C_Orientation[1] = 0.0f;
        //ABB_EGM_Control.C_Orientation[2] = 90.0;
    }
            ...
            while (exit_thread == false)
            {
                ...
                if (data != null)
                {
                    ...
                    // Luego, dentro del while
                     if (!UI_Ctrl.isManual)
                    {
                        ABB_EGM_Control.C_Position[0] = robot_msg.FeedBack.Cartesian.Pos.X;
                        ABB_EGM_Control.C_Position[1] = robot_msg.FeedBack.Cartesian.Pos.Y;
                        ABB_EGM_Control.C_Position[2] = robot_msg.FeedBack.Cartesian.Pos.Z;
                        ABB_EGM_Control.C_Orientation[0] = robot_msg.FeedBack.Cartesian.Euler.X;
                        ABB_EGM_Control.C_Orientation[1] = robot_msg.FeedBack.Cartesian.Euler.Y;
                        ABB_EGM_Control.C_Orientation[2] = robot_msg.FeedBack.Cartesian.Euler.Z;
                        /*
                        Debug.Log(
                            ABB_EGM_Control.C_Position[0].ToString("F2") + " " +
                            ABB_EGM_Control.C_Position[1].ToString("F2") + " " +
                            ABB_EGM_Control.C_Position[2].ToString("F2") + " " +
                            ABB_EGM_Control.C_Orientation[0].ToString("F2") + " " +
                            ABB_EGM_Control.C_Orientation[1].ToString("F2") + " " +
                            ABB_EGM_Control.C_Orientation[2].ToString("F2")
                        );
                        */
                    }
    ...
    class TCPIP_Control
    {
        ...
        public void TCPIP_Control_Thread()
        {
            ...
            while (exit_thread == false)
            {
                ...
                Debug.Log("asignar cliente, ip "+ ABB_TCP_Control.ip_address + " port " + ABB_TCP_Control.port_number);

                try
                {
                   
                    using (client = new TcpClient(ABB_TCP_Control.ip_address, ABB_TCP_Control.port_number))
                    {
                        Debug.Log("cliente asignado");
                        // Aquí puedes añadir el código para interactuar con el servidor
                    }
                }
